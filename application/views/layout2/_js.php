...
<script src="<?= base_url('assets/modernize/src/') ?>/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.js">
</script>
...
<script src="<?= base_url('assets/modernize/src/') ?>/assets/libs/apexcharts/dist/apexcharts.min.js"></script>
<script src="<?= base_url('assets/modernize/src/') ?>/assets/libs/simplebar/dist/simplebar.js"></script>
<script src="<?= base_url('assets/modernize/src/') ?>/assets/js/dashboard.js"></script>