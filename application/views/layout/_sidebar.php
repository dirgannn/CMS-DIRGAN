<div class="navbar-logo">
    <a href="index.html">
        <img src="<?= base_url('assets/Adminatorr/') ?>assets/images/logo/logo.svg" alt="logo" />
    </a>
</div>
    ...
    <ul>
        ...
        <li class="nav-item  <?php if ($menu == 'caraousel') {
            ...
            <a href="<?= site_url('admin/caraousel') ?>">
                ...
                <span class="text">Caraousel</span>
            </a>
        ...
        <li class="nav-item  <?php if ($menu == 'kategori') {
            ...
            <a href="<?= site_url('admin/kategori') ?>">
                ...
                <span class="text">Kategori Konten</span>
            </a>
        </li>
        ...
        <li class="nav-item  <?php if ($menu == 'konfigurasi') {
            ...
            <a href="<?= site_url('admin/konfigurasi') ?>">
                ...
                <span class="text"> Konfigurasi </span>
            </a>
